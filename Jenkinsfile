        ...
        stage ('Deployments'){
                    parallel{
                        stage ('Deploy to Staging'){
                            steps {
                                bat 'pscp -i C:/Users/zubin.kadva/Downloads/tomcat-demo.pem "C:/Program Files (x86)/Jenkins/workspace/fully-automated/webapp/target/*.war" ec2-user@${params.tomcat_dev}:/var/lib/tomcat7/webapps'
                            }
                        }
